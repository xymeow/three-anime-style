---
name: three-anime-style
description: Integrate the Anime Style for Three.js library into an existing scene, or debug its materials and post-processing. Use for this library’s cel shading, painted scenery, anime shadows, outlines and optional film texture.
---

# Anime Style for Three.js integration

Integrate into the user's existing scene and animation loop. Anime Style for Three.js exports `applyInk`, `InkPass`, `createBrushTexture`, and `steppedTime` from `@xymeow/three-anime-style`.
...
Full [API reference](https://github.com/xymeow/three-anime-style/blob/main/docs/api.md) and [integration example](https://github.com/xymeow/three-anime-style/blob/main/docs/integration.md).
